...
def upgrade():
    ...
    op.create_index(
        "idx_organization_memberships_user_id", "organization_memberships", ["user_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "idx_user_permissions_permission_id", "user_permissions", ["permission_id"]
    )
    op.create_index(
        "idx_user_permissions_resource",
        "user_permissions",
        ["resource_type", "resource_id"],
    )
    op.create_index("idx_user_permissions_granted", "user_permissions", ["is_granted"])
    op.create_index(
        "idx_user_permissions_expires_at", "user_permissions", ["expires_at"]
    )
    ...
    op.create_index(
        "idx_permission_audits_performed_at", "permission_audits", ["performed_at"]
    )
    op.create_index(
        "idx_permission_audits_performed_by", "permission_audits", ["performed_by"]
    )
    ...
    try:
        ...
        op.add_column(
            "users", sa.Column("default_organization_id", sa.Integer(), nullable=True)
        )
