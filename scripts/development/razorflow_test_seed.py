...
ENHANCED_TEMPLATES = [
        ...
        "training_qa": [
            {
                ...
                "answer": "I can access your calendar through the MCP calendar server and create meetings with automatic conflict detection and attendee notifications.",
            },
            {
                "question": "Can you manage my emails?",
                "answer": "Yes, I can read, compose, send, and organize your emails using the email MCP server integration.",
            },
        ],
        "tools": {
        ...
        "training_qa": [
            {
                ...
                "answer": "I can analyze your portfolio using real-time market data through the financial MCP server and provide comprehensive performance metrics.",
            },
            {
                "question": "Should I invest in tech stocks?",
                "answer": "Let me analyze current market conditions and your risk profile using the market data MCP integration to provide personalized investment advice.",
            },
        ],
        "tools": {
        ...
        "training_qa": [
            {
                ...
                "answer": "I can help you schedule appointments while ensuring all patient information remains secure and HIPAA compliant.",
            },
            {
                "question": "What are the clinic hours?",
                "answer": "I have access to current clinic schedules and can provide accurate availability information.",
            },
        ],
        "tools": {
        ...
        "training_qa": [
            {
                ...
                "answer": "I can track your order status using our integrated order management system and provide real-time updates.",
            },
            {
                "question": "Is this item in stock?",
                "answer": "Let me check our current inventory levels through the inventory management integration.",
            },
        ],
        "tools": {
    ...
    },
    {
        ...
        "training_qa": [
            {
                "question": "Find properties under $500k",
                "answer": "I can search MLS data and property databases to find suitable properties within your budget range.",
            },
            {
                "question": "Schedule property viewing",
                "answer": "I can coordinate property viewings and manage your showing schedule.",
            },
        ],
        "tools": {
    ...
    },
    {
        ...
        "training_qa": [
            {
                "question": "Plan a trip to Tokyo",
                "answer": "I can create a comprehensive Tokyo itinerary using weather data, local recommendations, and booking integrations.",
            },
            {
                "question": "What's the weather like in Paris?",
                "answer": "I can provide current and forecast weather conditions for Paris using integrated weather services.",
            },
        ],
        "tools": {
                ...
                for project_data in sample_projects:
                    ...
                    if not existing_bot.scalar_one_or_none():
                        chatbot = Chatbot(
                            ...
                            user_id=user.id,
                            client_id=client.id,
                            is_deployed=project_data["status"]
                            == ChatbotStatus.DEPLOYED,
                        )
                        session.add(chatbot)
